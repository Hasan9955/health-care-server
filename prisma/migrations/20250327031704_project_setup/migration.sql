/*
  ...
  - Made the column `updatedAt` on table `MedicalReport` required. This step will fail if there are existing NULL values in that column.

*/
-- AlterTable
ALTER TABLE "MedicalReport" ALTER COLUMN "updatedAt" SET NOT NULL;
